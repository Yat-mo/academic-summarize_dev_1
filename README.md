...
> [最新版本更新]https://github.com/Yat-mo/academic-summarize_dev_2

这是一个专为学生和研究人员设计的论文批量总结工具。它能自动处理PDF和Word格式的学术论文，生成清晰的总结和直观的思维导图，帮助你快速掌握论文精髓！
...
2. API 基础地址说明：
   ```
   # 默认使用 https://api.ephone.ai/v1
   # 如遇到 rate limit 限制，可以通过在 .env 中设置以下配置切换到其他 API：
   
   # 使用 OpenAI 官方 API
   OPENAI_API_BASE=https://api.openai.com/v1
   
   # 使用 Azure OpenAI API
   OPENAI_API_BASE=https://你的资源名称.openai.azure.com
   ```
